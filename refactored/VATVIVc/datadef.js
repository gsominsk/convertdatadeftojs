module.exports = { fields: 
   { id: { type: 'INTEGER', autoIncrement: true, primaryKey: true },
     ...
     fTaxAuthorityID: { public: true, type: 'TEXT' },
     VATVIVcMatrix: 
      { public: true,
        type: 'MATRIX',
        label: 'Math',
     ...
     fVATVIDate: { public: true, type: 'DATE' },
     fVATVIType: { public: true, type: 'TEXT' },
  ...
  indexes: { SerNrIndex325: { fields: [ 'fSerNr' ], indicesType: 'UNIQUE' } } }